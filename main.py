...
# Also displays the list of words that were generated above.
print(f"""
...
# Iteratives over words_in_file list and adds each word in to the Hash Table
# one word at a time (using Chaining for collisions)
